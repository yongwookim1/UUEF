            ...
            if args.unlearn != 'retrain':   
                ...
                if args.unlearn != "SCRUB" or epoch % 10 == 0:
                    ...
                    if args.evaluate_cka:
                        ...
                        retrained_model = utils.initialize_model(args.retrained_model_path, device, arch=args.arch)
                        unlearned_model = utils.initialize_model(f"{save_dir}/{args.unlearn}checkpoint.pth.tar", device, arch=args.arch)
