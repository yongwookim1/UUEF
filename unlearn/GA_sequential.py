...
@iterative_unlearn
def GA_sequential(data_loaders, model, criterion, optimizer, epoch, args, mask=None):
    ...
    if epoch <= 2:
        ...
        for layer in [model.layer1, model.layer2, model.layer3, model.fc]:
            for param in layer.parameters():
                param.requires_grad = False
    elif epoch <= 5:
        for layer in [model.layer3, model.fc]:
            for param in layer.parameters():
                param.requires_grad = True
        for layer in [model.layer1, model.layer2, model.layer4, model.avgpool]:
            for param in layer.parameters():
                param.requires_grad = False
    elif epoch <= 8:
        for layer in [model.layer1, model.layer2]:
            for param in layer.parameters():
                param.requires_grad = True
        for layer in [model.layer3, model.layer4, model.avgpool, model.fc]:
            for param in layer.parameters():
                param.requires_grad = False
